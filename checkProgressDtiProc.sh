...
echo
echo $a scans done
echo $b scans currently processing
echo $(($c+$d)) yet to be processed by makefile
echo $(($e + $f + $g+ $h + $nodir)) total scans can not be processed, missing files or errors
echo
...
echo
echo $nodir can not be processed, no directory exists
